...
<body>
    ...
    <?php
        ...
        if (isset($_POST["sbm"]))
        {
            ...
            $sql = "INSERT INTO sanpham (ten_sp, id_dm, gia_sp, gia_km, bao_hanh, chi_tiet_sp, anh_sp) VALUES ('$ten_sp', '$id_dm', '$gia_sp', '$gia_km', '$bao_hanh','$chi_tiet_sp','$image')";
            ...
            <div class="col py-3">
                ...
                <div class="card-body">
                    <form method="POST" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Giá</label>
                            <input type="text" name="gia_sp" class="form-control" require>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bao_hanh" class="form-control" require>
                        </div>

                        <div class="form-group">
                            <label for="">Chi tiết sản phẩm</label> <br>
                            <textarea cols="50" rows="5" name="chi_tiet_sp" class="form-control" require></textarea>
                        </div>
