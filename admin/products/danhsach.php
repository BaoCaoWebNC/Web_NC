                ...
                <table class="table table-striped table-bordered" id="sortTable">       
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img style="width: 75px;" src="../../pictures/products/<?php echo $row['anh_sp'] ?>"></td>
                            ...
                            <td>
                                <a href="sua.php?id_sp=<?php echo $row['id_sp']; ?>" class = "btn btn-primary">Sửa</a>
                                <a href="xoa.php?id_sp=<?php echo $row['id_sp']; ?>" onclick="return confirm('Bạn có muốn xóa thông tin này không?');" class = "btn btn-primary">Xóa</a>
                            </td>
                        </tr>
                        <?php 
                            }
