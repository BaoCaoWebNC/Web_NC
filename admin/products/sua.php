...
<body>
    ...
    <?php
        ...
        $sql_up = "SELECT * FROM sanpham where id_sp = $id_sp";
        ...
        if (isset($_POST["sbm"]))
        {
            ...
            $sql = "UPDATE sanpham
            SET ten_sp='$ten_sp', id_dm='$id_dm', gia_sp='$gia_sp', gia_km='$gia_km', bao_hanh='$bao_hanh', chi_tiet_sp='$chi_tiet_sp', anh_sp ='$image'
                WHERE id_sp='$id_sp'";
            if (mysqli_query($conn, $sql))
            {
                move_uploaded_file($image_tmp, "../../pictures/products/$image");
                ...
                <div class="card-body">
                    <form method="POST" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="id_dm">
                                <?php
                        ...
                        <div class="form-group">
                            <label for="">Giá</label>
                            <input type="text" name="gia_sp" class="form-control" require value ="<?php echo $row_up['gia_sp']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bao_hanh" class="form-control" require value ="<?php echo $row_up['bao_hanh']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="">Chi tiết sản phẩm</label> <br>
                            <textarea cols="50" rows="5" name="chi_tiet_sp" class="form-control" require><?php echo $row_up['chi_tiet_sp']; ?></textarea>
                        </div>
