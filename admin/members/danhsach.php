...
<head>
    ...
    <title>Admin | Danh sách thành viên</title>
</head>
<body>
    <?php
    if($_SESSION["name"]) {
                ...
                <table class="table table-striped table-bordered" id="sortTable">       
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($row['quyen_truy_cap']== 0) echo "Thành viên"; else if($row['quyen_truy_cap'] == 1) echo "Quản trị viên"; else if($row['quyen_truy_cap'] == 2) echo "Siêu quản trị viên" ?></td>
                            <td>
                                <a href="sua.php?id_thanhvien=<?php echo $row['id_thanhvien']; ?>" class = "btn btn-primary">Sửa</a>
                                <a href="xoa.php?id_thanhvien=<?php echo $row['id_thanhvien']; ?>" onclick="return confirm('Bạn có muốn xóa thông tin này không?');" class = "btn btn-primary">Xóa</a>
                            </td>
                        </tr>
                        <?php 
                            }
