...
<!--menu bar-->
	...
	<div id="wrapper">
		<script language="javascript" src="../user/login.js"></script>
		<form action=""method="POST" onsubmit="return validate()" id="form-login">
			<h1 class="form-heading">Đăng nhập</h1>
			<div class="form-group">
				<i class="far fa-user"></i>
				<input type="text" name="username" id="username"class="form-input" placeholder="Tên đăng nhập"autocomplete="off" autofocus />
			</div>
			<div class="form-group">
